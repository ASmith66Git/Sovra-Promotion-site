...
<p style="margin-bottom:1.25rem">Zero inbox is the normal state, not the exceptional one. The answer is a system that handles triage automatically, surfaces what actually needs your attention, and files or dismisses everything else. That's what we built Sovra to do — and to keep everything it learns about you entirely on your device.</p>
  ...
  "/blog/why-we-built-sovra": {
    ...
    description: "Sovra didn't start as a business idea. It started as frustration. Here's the honest story of why we built it and what it's actually trying to do.",
...
<article style="border:1px solid rgba(255,255,255,0.08);border-radius:1rem;padding:1.5rem;margin-bottom:1.25rem;background:rgba(30,41,59,0.5)">
  ...
  "/roadmap/intelligent-automation": {
    title: "Intelligent Automation — Sovra Road Map",
    ...
    ogTitle: "Intelligent Automation — Coming to Sovra",
    ogDesc: "Describe what you want in plain English. Sovra translates it into a rule that runs automatically. No flowcharts. No configuration.",
    bodyContent: `<div style="font-family:Inter,sans-serif;background:#0F172A;color:#F8FAFC;padding:2rem;max-width:800px;margin:0 auto">
...
<p style="color:#6366F1;line-height:1.75"><em>Sovra confirms:</em> "Updated — same rule but only when the invoice total is over £500. Save this?"</p>
  ...
  "/roadmap/multi-language": {
    title: "Multi-language Support — Sovra Road Map",
    ...
    ogTitle: "Multi-language Support — Coming to Sovra",
    ogDesc: "Sovra in your language. On-device AI triage, notes, and full interface for speakers of Spanish, French, German, Japanese, and more.",
    bodyContent: `<div style="font-family:Inter,sans-serif;background:#0F172A;color:#F8FAFC;padding:2rem;max-width:800px;margin:0 auto">
<nav style="margin-bottom:2rem"><a href="/roadmap" style="color:#94A3B8;text-decoration:none">← Road Map</a></nav>
...
<p style="color:#94A3B8;line-height:1.75">Spanish, French, German, Portuguese, Japanese, Korean, Simplified Chinese, Italian, Dutch, and Arabic — with more to follow.</p>
  ...
  "/roadmap/updated-ai-models": {
    title: "Updated AI Models — Sovra Road Map",
    description: "Sovra's on-device AI keeps getting smarter. Upcoming model updates bring sharper email triage, richer document intelligence, and faster responses — all without touching the cloud.",
    canonical: "https://sovra.app/roadmap/updated-ai-models",
    ogTitle: "Updated AI Models — Coming to Sovra",
    ogDesc: "Smarter triage, deeper document understanding, and faster responses — all still on your device. Learn what's coming to Sovra's on-device AI.",
    bodyContent: `<div style="font-family:Inter,sans-serif;background:#0F172A;color:#F8FAFC;padding:2rem;max-width:800px;margin:0 auto">
<nav style="margin-bottom:2rem"><a href="/roadmap" style="color:#94A3B8;text-decoration:none">← Road Map</a></nav>
...
<p style="color:#94A3B8;line-height:1.75">Better models will never mean your data leaves your device. Every model we ship runs entirely on your iPhone, iPad, or Apple Silicon Mac. Your notes, emails, and documents are the input; your device is the processor; you are the only one who sees the output.</p>
  ...
  "/roadmap/unified-inbox": {
    title: "Unified Inbox — Sovra Road Map",
    ...
    ogTitle: "Unified Inbox — Coming to Sovra",
    ogDesc: "Your relationships, not your channels. One inbox for email, WhatsApp, Signal, and more. Sovra replies on the best available channel — all on-device.",
    bodyContent: `<div style="font-family:Inter,sans-serif;background:#0F172A;color:#F8FAFC;padding:2rem;max-width:800px;margin:0 auto">
<nav style="margin-bottom:2rem"><a href="/roadmap" style="color:#94A3B8;text-decoration:none">← Road Map</a></nav>
...
function injectMeta(html: string, meta: PageMeta): string {
  let result = html
    .replace(
      /<title>.*?<\/title>/,
      `<title>${meta.title.replace(/</g, "&lt;").replace(/>/g, "&gt;")}</title>`
    )
    .replace(
    ...
    .replace(
      ...
      `<meta property="og:description" content="${escapeAttr(meta.ogDesc)}" />`
    )
    .replace(
    ...
    .replace(
      ...
      `<meta name="twitter:description" content="${escapeAttr(meta.ogDesc)}" />`
    );
