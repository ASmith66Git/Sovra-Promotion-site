        ...
        {mobileOpen && (
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-1">
              ...
              <Link href="/blog" onClick={closeMenu} data-testid="link-mobile-blog"><span className="block text-sm py-3 px-3 rounded-lg cursor-pointer" style={{ color: COLORS.muted }}>Blog</span></Link>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 mb-12">
          ...
          <nav className="flex flex-wrap items-center gap-6">
            ...
            <Link href="/blog" data-testid="link-footer-blog"><span className="text-sm transition-colors duration-200 cursor-pointer" style={{ color: COLORS.dimmed }}>Blog</span></Link>
