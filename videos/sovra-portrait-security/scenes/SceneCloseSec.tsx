...
export const SceneCloseSec: React.FC = () => {
  ...
  const badgeSpring = spring({ frame: frame - 70, fps, config: { damping: 10, stiffness: 70 } });
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src={SOVRA_LOGO_TRANSPARENT} alt="Sovra" style={{ width: "13cqw", height: "13cqw", objectFit: "contain", filter: "drop-shadow(0 0 2.5cqw rgba(52,211,153,0.8))" }} />
        <span style={{ fontSize: "11cqw", fontWeight: 900, color: "#F8FAFC", letterSpacing: "-0.02em", lineHeight: 1 }}>Sovra</span>
      </div>

      <p style={{
        fontSize: "7cqw", fontWeight: 800, color: "#F8FAFC",
      ...
      <p style={{
        fontSize: "7cqw", fontWeight: 900, textAlign: "center",
