...
export const SceneClosePV: React.FC = () => {
  ...
  const badgeSpring = spring({ frame: frame - 75, fps, config: { damping: 10, stiffness: 70 } });
  ...
  return (
    <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 8cqw", zIndex: 20, opacity: containerOp }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "3cqw", marginBottom: "5cqh", opacity: logoSpring, transform: `scale(${0.5 + 0.5 * logoSpring})` }}>
        <img src={SOVRA_LOGO_TRANSPARENT} alt="Sovra" style={{ width: "13cqw", height: "13cqw", objectFit: "contain", filter: "drop-shadow(0 0 2.5cqw rgba(99,102,241,0.9))" }} />
        <span style={{ fontSize: "11cqw", fontWeight: 900, color: "#F8FAFC", letterSpacing: "-0.02em", lineHeight: 1 }}>Sovra</span>
      </div>

      {/* Tagline — the manifesto close */}
      <p style={{ fontSize: "7cqw", fontWeight: 800, color: "#F8FAFC", textAlign: "center", lineHeight: 1.2, marginBottom: "1.5cqh", opacity: line1Op, transform: `translateY(${line1Y}px)` }}>
        Privacy isn't a feature.
      </p>
      <p style={{ fontSize: "7cqw", fontWeight: 900, textAlign: "center", background: "linear-gradient(90deg, #34D399, #6366F1)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", lineHeight: 1.2, marginBottom: "9cqh", opacity: line2Op, transform: `translateY(${line2Y}px)` }}>
        It's a stance.
      </p>
